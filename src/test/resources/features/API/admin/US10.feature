...
@US10
  Feature: As an administrator, I want to be able to update holiday information for the specified id number
            via API connection.
 ...
 Examples:
  ...
  | 82
    ...
    Scenario Outline: TC06 User must confirm the update of the holiday record via the API by sending a GET request to
